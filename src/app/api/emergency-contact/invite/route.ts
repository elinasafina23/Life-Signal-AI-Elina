...
// src/app/api/emergency-contact/resend/route.ts
...
export async function POST(req: NextRequest) {
  try {
    ...
    const role = normalizeRole(rawRole || "emergency-contact");
    ...
    await db.collection("mail").add({
      ...
      message: {
        ...
        html: `
          <p>Hello${mainUser.name ? " " + mainUser.name : ""},</p>
          <p>You’ve been re-invited to be an <strong>emergency contact</strong>.</p>
